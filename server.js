...
app.listen(PORT, () => {
    console.log(
        `SHOP App: Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`
    );
    logger.debug(`SHOP App: Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`);
});
